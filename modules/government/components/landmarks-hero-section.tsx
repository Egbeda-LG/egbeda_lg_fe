...
export function LandmarksHeroSection() {
  return (
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div className="max-w-2xl space-y-3">
            ...
            <p className="font-sans text-sm leading-relaxed text-[#6A7181] sm:text-base">
              The industries, landmarks and cultural traditions that define our
              local government anchors of employment, heritage and everyday life
              across 420.75 sq km of Oyo State.
            </p>
