...
export function ExecutiveCouncilHeroSection() {
  return (
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div className="max-w-2xl space-y-3">
            ...
            <h1 className="font-heading text-3xl leading-tight font-extrabold tracking-tight text-[#131313] sm:text-4xl lg:text-5xl">
              Executive Council/ Political Functionaries
            </h1>

            {/* Subtitle */}
            <p className="font-sans text-sm leading-relaxed text-[#6A7181] sm:text-base">
              The Executive Chairman leads the council with a Vice Chairman and
              Supervisory Councillors, each holding portfolio responsibility for
              a policy area.
            </p>
