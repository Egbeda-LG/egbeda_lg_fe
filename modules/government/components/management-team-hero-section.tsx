...
export function ManagementTeamHeroSection() {
  return (
        ...
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div className="max-w-2xl space-y-3">
            ...
            <p className="font-sans text-sm leading-relaxed text-[#6A7181] sm:text-base">
              Under the Head of Local Government Administration, career civil
              servants direct the council&apos;s eight operational departments
              and deliver services to citizens.
            </p>
            ...
            <div className="flex items-center gap-2 pt-2 font-sans text-xs font-medium text-[#6A7181]">
              ...
              <span>/</span>
              <span className="font-bold text-[#D9A300]">Management Team</span>
            </div>
          </div>
