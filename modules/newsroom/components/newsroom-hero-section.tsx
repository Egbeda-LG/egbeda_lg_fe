      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
          ...
          <div className="max-w-2xl space-y-3">
            ...
            {/* Breadcrumbs or Back to newsroom */}
            {showBackButton ? (
              <div className="pt-2">
                <Link
                  href="/newsroom"
                  className="inline-flex items-center gap-1 text-xs font-bold text-[#D9A300] hover:underline"
                >
                  Back to newsroom
                </Link>
              </div>
              ...
              <div className="flex items-center gap-2 pt-2 font-sans text-xs font-medium text-[#6A7181]">
                ...
                <span>/</span>
                <span className="font-bold text-[#D9A300]">Newsroom</span>
              </div>
            )}
          </div>
